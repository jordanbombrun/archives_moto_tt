...
from RankingMotoApp.app.views.race_view import add_race, add_serie, render_form_add_race, render_list_race

# param :  rule = URL , view_func = fonction to be called in the view
app.add_url_rule(rule= '/', view_func= render_home)
app.add_url_rule(rule='/lister_courses', view_func=render_list_race)
